...
* Smart Contract (In)Security - How to lose money without trading (Simone Bovi)
...
* The CAN Link-Layer, or how we implemented a broken protocol and can we fix it (Stefano Longari)
